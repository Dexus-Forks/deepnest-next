...
| Review-protocol board verdict rule (default) + `severity.max=P1 → APPROVED` carve-out (5 entry criteria + 2 operational invariants) | `_bmad-output/sops/review-protocol-severity-p1-carve-out.md` (proposed via [DEE-142](/DEE/issues/DEE-142); precedent [DEE-131](/DEE/issues/DEE-131)) |
